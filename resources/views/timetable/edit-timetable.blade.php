...
@section('content')
    <div class="container-fluid">
        <h1 class="h3 mb-2 text-gray-800">Edit Timetable</h1>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Edit Timetable</h6>
            </div>
            <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="teacher_id" id="teacher_id" class="form-control form-select">
                            @foreach ($teachers as $item)
                                <option value="{{ $item->id }}">{{ $item->name }} - {{ $item->course->course_name }}
                                </option>
                            @endforeach
                        </select>
                    </div>
